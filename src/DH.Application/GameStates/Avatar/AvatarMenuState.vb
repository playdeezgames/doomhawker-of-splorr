Friend Class AvatarMenuState
    ...
    Public Overrides Sub Render(displayBuffer As IPixelSink(Of Integer))
        ...
        If avatar IsNot Nothing Then
            ...
            font.WriteText(displayBuffer, (0, font.Height * 5), $"Map Name: {avatar.MapName}", 15)
            font.WriteText(displayBuffer, (0, font.Height * 6), $"Column: {avatar.Column}", 15)
            font.WriteText(displayBuffer, (0, font.Height * 7), $"Row: {avatar.Row}", 15)
            Dim creature As ICreatureInstance = avatar.Creature
            font.WriteText(displayBuffer, (0, font.Height * 8), $"Creature: {creature.Creature.Name}", 15)
        End If
    End Sub
End Class
